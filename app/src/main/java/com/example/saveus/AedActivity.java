...
public class AedActivity extends MainActivity implements OnMapReadyCallback, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    ArrayList aedName = new ArrayList<>();
    ArrayList aedLat = new ArrayList<>();
    ArrayList aedLng = new ArrayList<>();
    ArrayList aedMarkers= new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            for(int i = 0; i < arr.length(); i++) {
                ...
                aedName.add(dataObj.getString("org"));
                aedMarkers.add(dataObj.getString("rnum"));
            }
    ...
    private String getJsonString() {  //json 파싱 성공
        String ret = "";
        try {
            InputStream inputStream = getAssets().open("modified_aed.json");
