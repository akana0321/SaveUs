...
public class PatientActivity extends MainActivity {
    ...
    static final String[] REQUIRED_PERMISSIONS = new String[]{"android.permission.CAMERA","android.permission.WRITE_EXTERNAL_STORAGE"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "tag:DoNotDimScreen");
